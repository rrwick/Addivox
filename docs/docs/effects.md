...
<p align="center"><img src="../assets/effects.png" alt="Addivox effects" style="width: 30%;"></p>
...
These are simple one-knob effects, intended mainly to give the standalone versions of Addivox a finished sound. When using Addivox as a plugin in a DAW, you may prefer to leave them off and use dedicated effects plugins instead.
