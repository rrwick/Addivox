...
#define PLUG_VERSION_COMMAS PLUG_VERSION_MAJOR,PLUG_VERSION_MINOR,PLUG_VERSION_PATCH,0
#define PLUG_VERSION_STRINGIFY(value) #value
#define PLUG_VERSION_EXPAND_AND_STRINGIFY(value) PLUG_VERSION_STRINGIFY(value)
#define PLUG_VERSION_STR PLUG_VERSION_EXPAND_AND_STRINGIFY(PLUG_VERSION_MAJOR) "." PLUG_VERSION_EXPAND_AND_STRINGIFY(PLUG_VERSION_MINOR) "." PLUG_VERSION_EXPAND_AND_STRINGIFY(PLUG_VERSION_PATCH)
#if ADDIVOX_DEMO
