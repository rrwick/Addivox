...
inline EqCurve MakeEqShapeCurve(const char* shapeName)
{
  ...
  if(shape == "i vowel")
  {
    ...
    static constexpr std::array<double, 21> kGainsDb{{      -10.669079408627, -10.627677183356, -7.653731138546, -0.790423715897,  -3.491380691528, -8.905270538028, -18.610932784636, -17.994479500076, -17.990288065844, -16.044532845603, -8.024493217497, 3.784863587868, 19.429210486206, 9.729722603262, 5.120969364426, 14.739050449627, 6.199210486206, -0.81755067825,  -2.268104553223, -3.044410912971}};
  ...
  if(shape == "e vowel")
  {
    ...
    static constexpr std::array<double, 18> kGainsDb{{      -6.774016494776, -6.370438110722, 0.928027570323, 13.121990211519, 5.646713746211, -7.988411319413, -16.955760470118, -11.763774153669, 4.074336567935, 19.356431099595, 9.878782028485, 4.36175887822, 12.8480617792, 5.465266134905, -0.903810394757, -2.935451912818, -3.380912462531}};
    return MakeEqCurveFromPointArrays(kFrequenciesHz, kGainsDb);
  }
  ...
  if(shape == "ä vowel")
  {
    ...
    static constexpr std::array<double, 15> kGainsDb{{      -4.962230274005, -4.021422169249, 4.928410455634, 19.357417626702,  10.525862216949, 21.477278533181,   -3.714440345764, -16.259403431515, -11.138957323668, -5.15167181126, 5.157596762298, 0.628089253468, -6.342189667428, -6.834614978987}};
    return MakeEqCurveFromPointArrays(kFrequenciesHz, kGainsDb);
  }
  ...
  if(shape == "o vowel")
  {
    ...
    static constexpr std::array<double, 16> kGainsDb{{      -1.298474949376, -1.293219805343,    1.80323266983, 16.355452348292,  10.261422157288, 20.113071003985, 8.345592265987, -9.174591547456, -19.191716375988, -13.200635443203, -5.131875498073, 3.958136847606,   -3.153233528137, -8.009878241557, -8.153263701091}};
    return MakeEqCurveFromPointArrays(kFrequenciesHz, kGainsDb);
  }
  ...
  if(shape == "u vowel")
  {
    ...
    static constexpr std::array<double, 16> kGainsDb{{      -2.743455418381,  -2.475646018982, 9.730978052126, 5.104769547325, 7.982293552812, 18.222556927298, 7.999001371742, -10.462100137174, -22.0289478738, -15.418170096022, -5.914683127572, 0.883015089163,   -6.576078414917, -9.493193415638, -9.599301783265}};
    return MakeEqCurveFromPointArrays(kFrequenciesHz, kGainsDb);
  }
