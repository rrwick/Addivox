...
template <typename TFrame, int QUEUE_SIZE = 128>
class HarmonicVisualizerSender : public iplug::ISender<1, QUEUE_SIZE, TFrame>
{
public:
  ...
  template <typename FillFrameFunc>
  void ProcessBlock(int nFrames, int ctrlTag, FillFrameFunc&& fillFrame)
  {
